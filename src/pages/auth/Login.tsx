    ...
    <>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 p-4 rounded-lg bg-primary/10 border border-primary/20">
            ...
            <p className="text-xs">Email: demo@exotics.lk</p>
      ...
      <div className="hidden lg:flex flex-1 relative bg-muted items-center justify-center p-12">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1525609004556-c46c7d6cf023?q=80&w=2070&auto=format&fit=crop"
            alt="Luxury Car"
        ...
        <div className="relative z-10 max-w-lg text-center">
          ...
          <p className="text-lg text-muted-foreground">
            Join Sri Lanka's most trusted luxury car marketplace. Buy, sell, and discover exceptional vehicles.
          </p>
        </div>
      </div>
    </div>
