              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid gap-3">
                    {roles.filter(r => r.value !== 'dealer').map((r) => (
                      <button
                        key={r.value}
                        type="button"
                  ...
                  <div className="mt-4 p-4 rounded-lg bg-gold/10 border border-gold/20">
                    <div className="flex items-start gap-3">
                      <div className="p-2 rounded-full bg-gold/20 text-gold-foreground">
                        <User className="h-4 w-4" />
                      </div>
                      <div>
                        <h4 className="font-semibold text-sm text-foreground">Are you a Dealer?</h4>
                        <p className="text-xs text-muted-foreground mb-3">
                          We've updated our curated network. New dealers must now apply for verification.
                        </p>
                        <Link to="/dealer/apply" className="text-sm font-medium text-primary hover:underline">
